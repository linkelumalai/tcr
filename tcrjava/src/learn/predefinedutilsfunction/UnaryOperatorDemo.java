...
public class UnaryOperatorDemo {
	...
	public static void main(String[] args) {
		...
		// when use the unary we can access the unaray via the and then we can directly
		// use the
		// function interface because it is inherited by the unary interface , in the
		// below code we don't want
		...
		System.out.println(ouput1.apply(5));
